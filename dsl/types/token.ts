type TokenType = 'TOKEN_SHELL' | 'TOKEN_REPLACE' | 'TOKEN_STRING' | 'TOKEN_NUMBER' | 'TOKEN_IDENTIFIER' | 'TOKEN_EOF' | 'TOKEN_CREATEFILE' | 'TOKEN_READFILE' | 'TOKEN_DELETEFILE' | 'TOKEN_LISTFILES' | 'TOKEN_APPEND' | 'TOKEN_DELETELINE' | 'TOKEN_SEARCH' | 'TOKEN_RESPOND'
